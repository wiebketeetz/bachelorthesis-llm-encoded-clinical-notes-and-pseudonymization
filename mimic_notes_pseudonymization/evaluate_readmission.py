...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Path to embeddings file (.feather produced by precompute script or legacy .npy)",
    )
    parser.add_argument(
        "--labels-path",
        type=Path,
        required=True,
        help="Path to labels file (.feather produced by precompute script or legacy .npy)",
    )
    parser.add_argument(
        "--test-size",
        type=float,
...
def main() -> None:
    ...
    if embeddings.shape[0] != labels.shape[0]:
        raise ValueError("Embeddings and labels have mismatched row counts")
    ...
    summary = {
        "embeddings_path": str(args.embeddings_path.resolve()),
